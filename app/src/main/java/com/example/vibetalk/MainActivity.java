...
import com.example.vibetalk.Profile.ProfileActivity;
import com.example.vibetalk.chats.ChatFragment;
import com.example.vibetalk.findfriends.FindFriendsFragment;
import com.example.vibetalk.requests.RequestsFragment;
        ...
        public Fragment getItem(int position) {
            switch(position)
            {
                case 0: ChatFragment chatFragment=new ChatFragment();
                               return chatFragment;
                case 1: RequestsFragment requestsFragment=new RequestsFragment();
                             return requestsFragment;
                case 2: FindFriendsFragment findFriendsFragment=new FindFriendsFragment();
